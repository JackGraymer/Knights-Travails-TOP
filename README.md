...
The objective is to use the algorithm knowledge from previous lessons to build a data structure and an algorithm that will find the shortest path between two nodes. <br>
